...
<html>
    ...
    <body>
        ...
        <div class="log-container">
            <c:if test="${not empty param.msg}"><p style="color:green; font-weight:bold;">✅ Issue resolved successfully!</p></c:if>
            <c:if test="${not empty param.error}"><p style="color:red; font-weight:bold;">❌ Failed to resolve issue. Please check permissions.</p></c:if>

            <table>
                <thead><tr><th>Alert ID</th><th>Device</th><th>Session</th><th>Type</th><th>Risk</th><th>Created At</th><th>Summary</th><th>Action</th></tr></thead>
                <tbody>
